...
import './LogoGather.less'
//import goldeye from './goldeye.png'
...
export default class LogoGather extends Component {
    ...
    static defaultProps = {
        image: 'http://127.0.0.1:3005/hackweek.png',
    ...
    render() {
        ...
        return (<div className="logo-gather-demo-wrapper" style={{height:winHeight,overflow:'hidden'}}>
            <canvas id="canvas"/>
            <TweenOne
